<?php
    ...
    if(isset($_POST['submit'])){
    	...
    	if(empty($error)){
    		mail("tweetjobs@burnsoft.co.uk", "iPhone: '" . $subject . "'",
    			"Name: \t\t\t" . $name . "\n\nEmail:\t\t\t". $mail ."\n\Message: \n" . stripslashes($comments) . "\n\n",
    			"From: theweb@domain.com\r\nReply-To: $mail\r\n");
...
<?php } ?>            
        ...
        <div id="footer">
            <p><strong>Copyright &copy; 2010</strong> by <a href="www.burnsoft.co.uk">Burnsoft Ltd</a>. Design by <a href="http://jonnotie.nl">Jonnotie</a></p>
        </div>
    </div>
</body>
</html>